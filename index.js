...
app.get("/joyas", async (req, res) => {
  ...
  try {
    ...
    const HATEOAS = await prepararHATEOAS(joyas); //Llamamos la función que formatea los datos en HATEOAS enviando como argumento el arreglo de la consulta
    res.status(200).json(HATEOAS); //Respondemos al frontend con el objeto que contiene las joyas en formato HATEOAS y mensaje 200.
  } catch (error) {
